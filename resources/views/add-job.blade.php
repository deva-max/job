...
<html lang="en">
  <body class="aside-collapsed">
          ...
          <div class="container-fluid">
            <div class="panel panel-default">
              <div class="panel-body">
                <form method="POST" action="{{ route("add-job.create") }}">
                  @csrf
                  <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        <select name="" class="form-control select2-2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="" required>
                          <option value="">Select</option>
                          @foreach($customerDatas as $customerData)
                            <option value="{{ $customerData->customer }}">{{ $customerData->customer }}</option>
                          @endforeach
                        </select>
                        <span class="input-group-addon cp" data-toggle="modal" data-target="#add-customer">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        ...
                        <div class="input-group">
                          <select name="" class="form-control select2-2 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                            <option value="">Select</option>
                            @foreach($partNumberDatas as $partNumberData)
                              <option value="{{ $partNumberData->part_number }}">{{ $partNumberData->part_number }}</option>
                            @endforeach
                          </select>
                      ...
                      <div class="col-md-1">
                        <button type="button" class="btn btn-success addMore" style="margin-top: 25px;">
                          <i class="fa fa-plus"></i>
                        </button>
                      </div>
                    </div>
    ...
    <div class="modal fade in" id="add-partnumber">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <form action="{{ route('pn.create') }}" method="POST">
            @csrf
            <div class="modal-body pt-0">
              <div class="form-group mb row ml-0">
                <div class="col-md-12">
                  <label class="control-label">Part number</label>
                  <input type="number" name="part_number" class="form-control" placeholder="Part number" required>
                </div>
              </div>
              <div class="form-group mb row ml-0">
                <div class="col-md-12">
    ...
    <!-- Add customer -->
    <div class="modal fade in" id="add-customer">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">×</button>
