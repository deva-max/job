        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="pull-right">
                    <a href="{{ route('add-job') }}" class="btn btn-sm btn-primary" style="margin-bottom: 5px;">
            ...
            <div class="panel panel-default">
                ...
                <tbody>
                    @foreach($viewCustomers as $key => $customer)
                    <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ 't' . (1253 + $key) }}</td> <!-- Assuming 1253 is the starting job number -->
                        <td>{{ $customer->customer }}</td>
                        <td>
                            @if (isset($viewPartNumbers[$key]))
                                {{ $viewPartNumbers[$key]->part_number }}
                            @else
                                N/A
                            @endif
                        </td>
